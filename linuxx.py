...
while True:
    ...
    if linx == '01' or linx == '1':
        ...
        print()
        print("\033[1;91m[*]\033[1;97m Udating LinuxX in your Termux\n")
        os.system("git clone https://github.com/MrHacker-X/LinuxX.git")
        os.system("rm /data/data/com.termux/LinuxX/linuxx.py")
        os.system("chmod +x LinuxX/*")
        os.system("mv LinuxX/linuxx.py /data/data/com.termux/LinuxX")
        os.system("rm -rf LinuxX")
        print()
